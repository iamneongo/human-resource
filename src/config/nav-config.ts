...
/**
 * Navigation cho HRM.
 * Visibility ở đây chỉ phục vụ UX; phân quyền thực thi vẫn được kiểm tra server-side.
 */
    ...
    items: [
      {
        ...
        items: [
          ...
          { title: 'Thôi việc', url: '/dashboard/hr/offboarding', disabled: true },
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Bảng chấm công thủ công', url: '/dashboard/attendance/timesheets' },
          { title: 'Định biên & tracking ngày', url: '/dashboard/attendance/staffing-tracking' },
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'Công thức tính lương', url: '/dashboard/payroll/formulas' },
          { title: 'BHXH & Thuế TNCN', url: '/dashboard/payroll/insurance-tax' },
          { title: 'Biến động lương', url: '/dashboard/payroll/adjustments' },
          { title: 'Kỳ lương & chốt lương', url: '/dashboard/payroll/runs' },
